...
export const profileConfig: ProfileConfig = {
	...
	name: "Mikuwu Ogiwara",
	bio: "Girl who loves play weeb rhythm games and watch anime  o/ (maimai, chunithm, taiko, ongeki, SDVX, Diva, PJSK and VSRG) neko & yuri enjoyer Bocchi The Rock simp",
	links: [
		{
			name: "Twitter",
			...
			url: "https://twitter.com/Mikutherock",
		},
		{
			name: "Twitch",
			icon: "fa6-brands:twitch",
			url: "https://Twitch.tv/MikuTheRock",
		},
		{
			name: "Youtube",
			icon: "fa6-brands:youtube",
			url: "https://www.youtube.com/@Mikuwuwu",
		},
	],
};
